  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'number',
        placeholder: '30',
        description: 'Target video length. 30s = 3 clips ($2.10), 60s = 6 clips ($4.20)',
      },
      {
        key: 'max_clips',
        ...
        type: 'select',
        options: [
          { value: '1', label: '1 clip — 10s ($0.70)' },
          { value: '2', label: '2 clips — 20s ($1.40)' },
          { value: '3', label: '3 clips — 30s ($2.10) ← recommended' },
          { value: '4', label: '4 clips — 40s ($2.80)' },
          { value: '5', label: '5 clips — 50s ($3.50)' },
          { value: '6', label: '6 clips — 60s ($4.20)' },
          { value: '9', label: '9 clips — 90s ($6.30)' },
        ],
        description: 'Number of Kling video clips per Short. Directly controls fal.ai cost.',
      },
      {
        key: 'script_tone',
        label: 'Script tone',
